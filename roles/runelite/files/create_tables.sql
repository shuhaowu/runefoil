...
--
-- Table for `runelite` that is not already created automatically
-- Obtained from ./http-service/target/classes/net/runelite/http/service/session/session.sql
...
CREATE TABLE IF NOT EXISTS `runelite`.`session` (
  ...
  `start` timestamp(6) NOT NULL DEFAULT '0000-00-00 00:00:00',
  `last` timestamp(6) NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`),

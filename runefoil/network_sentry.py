...
RESTRICTED_NSSWITCH_PATH = os.path.join(FILES_PATH, "nsswitch.conf.restricted")
UNRESTRICTED_NSSWITCH_PATH = os.path.join(FILES_PATH, "nsswitch.conf.unrestricted")
...
def enable_network_restrictions():
  ...
  allowed_hosts.append(["api.runelite.net", "127.0.0.1"])
...
def monitor_network_restrictions():
  pass
